...
-(void)viewDidLoad {
    ...
    [super viewDidLoad];
    //mettendo questa linea di codice facciamo si che ogni qual volta la view è caricata l'array è uguale all'array nello nsuserdefaults
    //se non mettiamo questa linea di codice dopo che chiudiamo l'app,ciò che abbiamo salvato non sarà più in memoria
